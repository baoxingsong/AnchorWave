                ...
                for (int32_t k = 0; k < ref1Ref2BlocksForMsas.size(); ++k) {
                    if (k != i && k != j ) {
                        if ( ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getChr().compare(ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getChr()) == 0 && (
                            (ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getStart() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getStart() && ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getStart() <= ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[0].getEnd()) ||
                            ...
                            (ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getStart() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getStart() && ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getStart() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getEnd()) ||
...
//                            std::cout << "line 73" << std::endl;
                        ...
                        if( ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getChr().compare(ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getChr()) == 0 &&  (
                            (ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() && ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getEnd()) ||
                            ...
                            (ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getStart() && ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getEnd()) ||
                            ...
                            (ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() && ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getEnd()) ||
                            ...
                            (ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getStart() && ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getEnd()) ||
...
//                            std::cout << "reference1 inversion is same with the outgroup" << std::endl;
                    ...
                    for (int32_t j = 0; j < ref2QueryBlocksForMsas.size(); ++j) {
                        if ( ref2QueryBlocksForMsas[j].getAlignmentBlocks()[0].getChr().compare(ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getChr()) == 0 &&
                            ( (ref2QueryBlocksForMsas[j].getAlignmentBlocks()[0].getStart() <= (*blocksForMsa->getPrev()).getAlignmentBlocks()[1].getEnd() && (*blocksForMsa->getPrev()).getAlignmentBlocks()[1].getEnd() <= ref2QueryBlocksForMsas[j].getAlignmentBlocks()[0].getEnd()) ||
                                    (ref2QueryBlocksForMsas[j].getAlignmentBlocks()[0].getStart() <= (*blocksForMsa->getPrev()).getAlignmentBlocks()[1].getStart() && (*blocksForMsa->getPrev()).getAlignmentBlocks()[1].getStart() <= ref2QueryBlocksForMsas[j].getAlignmentBlocks()[0].getEnd())) &&
                        ...
                        if (ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[0].getEnd() < ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getStart()) {
                            ...
                            for (int32_t k = 0; k < ref1Ref2BlocksForMsas.size(); ++k) {
                                if (ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getChr().compare(ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getChr()) == 0 && i!=k && j!=k) {
                                    if ((ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[0].getEnd() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getStart() && ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getStart() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getStart()) ||
                                        (ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[0].getEnd() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getEnd() && ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getEnd() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getStart()) ||
                                        (ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getStart() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getStart() && ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getStart() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getEnd()) ||
                                        (ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getStart() <= ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[0].getEnd() && ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[0].getEnd() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[0].getEnd())
                                    ) {
                            ...
                            if (!ifHasIntermedia) {
                                for (int32_t l = 0; l < ref1QueryBlocksForMsas.size(); ++l) { // we do not have strand problem for ref1
                                    if (ref1QueryBlocksForMsas[l].getAlignmentBlocks()[0].getChr().compare(ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getChr()) == 0 &&
                                        ref1QueryBlocksForMsas[l].getAlignmentBlocks()[0].getStart() <=ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[0].getEnd() && ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getStart() <=ref1QueryBlocksForMsas[l].getAlignmentBlocks()[0].getEnd()) {
                        ...
                        if ( ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getStrand() == POSITIVE && ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getEnd() < ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getStart()) {
                            ...
                            for (int32_t k = 0; k < ref1Ref2BlocksForMsas.size(); ++k) {
                                if (ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getChr().compare(ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getChr()) == 0 && i!=k && j!=k) {
                                    if ((ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getEnd() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() &&  ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getStart()) ||
                                        (ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getEnd() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getEnd() && ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getEnd() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getStart()) ||
                                        ( ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getEnd()  && ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getEnd() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getEnd()) ||
                                        ( ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getStart()  && ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getStart() <= ref1Ref2BlocksForMsas[k].getAlignmentBlocks()[1].getEnd())
                                    ) {
                                        ifHasIntermedia = true;
                            ...
                            if (!ifHasIntermedia) {
                                for (int32_t l = 0; l < ref2QueryBlocksForMsas.size(); ++l) {
                                    if (ref2QueryBlocksForMsas[l].getAlignmentBlocks()[0].getChr().compare(ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getChr()) == 0 &&
                                        ref2QueryBlocksForMsas[l].getAlignmentBlocks()[0].getStart() <= ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getEnd() && ref1Ref2BlocksForMsas[j].getAlignmentBlocks()[1].getStart() <= ref2QueryBlocksForMsas[l].getAlignmentBlocks()[0].getEnd()) {
                                        ref1Ref2BlocksForMsas[i].setPrev(&(ref1Ref2BlocksForMsas[j]));
                                        ref1Ref2BlocksForMsas[j].setNext(&(ref1Ref2BlocksForMsas[i]));
                                        ref1Ref2BlocksForMsas[i].setWhichRef("ref2Links");
                                    }
...
//        std::cout << "line 545\t" << ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getAlignSeq().size() << "\t" << alin0.size() << std::endl;
    ...
    for( int32_t i=0; i< ref1Ref2BlocksForMsas.size(); ++i  ) {
        std::string seq;
        for( int32_t pi=0; pi < ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[0].getAlignSeq().length(); ++pi ){
            if( ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getAlignSeq()[pi] == ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[2].getAlignSeq()[pi] || (ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getAlignSeq()[pi] == '-' && ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[2].getAlignSeq()[pi]=='*') ){
                if( ref1Ref2BlocksForMsas[i].getAlignmentBlocks()[1].getAlignSeq()[pi]!='-' ){
...
//                std::cout << "line 650\t" << usingRef1Strand << std::endl;
                if( (blocksForMsa->getWhichRef().compare("ref1") ==0 || blocksForMsa->getWhichRef().compare("NA") ==0 ) && usingRef1Strand && blocksForMsa->getAlignmentBlocks()[1].getStrand()==blocksForMsa->getPrev()->getAlignmentBlocks()[1].getStrand()){
                    ...
                    seq += blocksForMsa->getAncestralSequence();
                }else if( (blocksForMsa->getWhichRef().compare("ref1") ==0 || blocksForMsa->getWhichRef().compare("NA") ==0 ) && !usingRef1Strand && NEGATIVE==blocksForMsa->getAlignmentBlocks()[1].getStrand() && blocksForMsa->getAlignmentBlocks()[1].getStrand()==blocksForMsa->getPrev()->getAlignmentBlocks()[1].getStrand()){
  ...
  //                      std::cout << "line 722" << std::endl;
                    ...
                    seq += blocksForMsa->getAncestralSequence();
                }else if( blocksForMsa->getWhichRef().compare("ref2") ==0 && blocksForMsa->getAlignmentBlocks()[1].getStrand()!=blocksForMsa->getPrev()->getAlignmentBlocks()[1].getStrand() && POSITIVE==blocksForMsa->getPrev()->getAlignmentBlocks()[1].getStrand() && usingRef1Strand  ){
                ...
                }else if( blocksForMsa->getWhichRef().compare("ref2") ==0 && blocksForMsa->getAlignmentBlocks()[1].getStrand()!=blocksForMsa->getPrev()->getAlignmentBlocks()[1].getStrand() && NEGATIVE==blocksForMsa->getPrev()->getAlignmentBlocks()[1].getStrand() && !usingRef1Strand  ){
                ...
                }else if( (blocksForMsa->getWhichRef().compare("ref1") ==0 || blocksForMsa->getWhichRef().compare("NA") ==0 ) && !usingRef1Strand && NEGATIVE==blocksForMsa->getPrev()->getAlignmentBlocks()[1].getStrand() && NEGATIVE == blocksForMsa->getAlignmentBlocks()[1].getStrand() && blocksForMsa->getPrev()->getAlignmentBlocks()[1].getEnd() < blocksForMsa->getAlignmentBlocks()[1].getStart() ){
                    if( blocksForMsa->getPrev()->getAlignmentBlocks()[1].getEnd()+1 < blocksForMsa->getAlignmentBlocks()[1].getStart() ){
                    ...
                    std::cout << "line 585 unknown\t" << blocksForMsa->getWhichRef() << "\t" << blocksForMsa->getPrev()->getAlignmentBlocks()[1].getEnd() << "\t" << blocksForMsa->getAlignmentBlocks()[1].getStart() << "\t" << blocksForMsa->getPrev()->getAlignmentBlocks()[1].getStrand()
