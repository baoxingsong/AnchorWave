...
void setupAnchorsWithSpliceAlignmentResultQuota( const std::string & gffFilePath, const std::string & samFile, const std::string & cdsSequenceFile, std::vector<std::vector<AlignmentMatch>> & alignmentMatchsMap,
                                                 ...
                                                 double & calculateIndelDistance, const int & minExon, const int64_t & windownWidth, const double & minimumSimilarity, const double & minimumSimilarity2, std::map<std::string, std::string>& parameters, std::map<std::string, std::string> & referenceGenome,
