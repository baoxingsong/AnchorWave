                            ...
                            case 'M':
                                ...
                                for ( int32_t ii = 0; ii < refSeq.size(); ++ii )  {
                                    if ( refSeq[ii] != querySeq[ii] ){
                                        ovcffile << databaseChr << "\t" << std::to_string(databasePosition + ii ) << "\t" << databaseChr << "_" << std::to_string(databasePosition + ii ) <<"\t" << refSeq[ii] << "\t" << querySeq[ii] << "\t50\tPASS\tDP=1\tGT:GQ:DP\t1|1:50:1" << std::endl;
                                    }
                                }
